...
static const char *const yytname[] =
{
  ...
  "RETURN", "VOID", "WHILE", "PLUS", "MINUS", "TIMES", "SLASH", "LT", "LE",
  "GT", "GE", "DEQUAL", "DIFFERENT", "EQUAL", "SEMICOLON", "COMMA",
  "LPAREN", "RPAREN", "LBRACKET", "RBRACKET", "RBRACE", "LBRACE", "NUM",
  "ID", "ERROR", "$accept", "program", "decl_lista", "decl", "fun_decl",
  "params", "param_lista", "param", "local_decl", "var_decl", "num",
  "tipo", "statement_lista", "statement", "composto_decl", "selecao_decl",
  "iteracao_decl", "retorno_decl", "exp_decl", "exp", "simples_exp",
  "relacional", "soma_exp", "soma", "termo", "mult", "fator", "var", "id",
...
{
      41,   -60,   -60,     8,    41,   -60,   -60,   -60,   -24,   -60,
     -60,   -60,     5,   -60,    47,     6,    -8,    33,    28,   -60,
     -24,   -60,    32,    37,    41,    36,    45,   -60,   -60,   -60,
      46,   -60,    41,   -60,   -60,   -24,     4,   -18,    50,   -11,
      57,   -60,    22,   -60,   -60,   -60,   -60,   -60,   -60,   -60,
     -60,    61,   -60,    60,    26,   -60,    63,    31,   -60,    22,
     -60,    64,    22,    62,   -60,   -60,   -60,   -60,   -60,   -60,
     -60,   -60,   -60,    22,    22,   -60,   -60,    22,    22,    22,
      22,    65,   -60,    66,   -60,    53,   -60,    26,   -60,   -60,
     -60,    67,    59,    58,    39,    39,   -60,    22,   -60,    82,
     -60,   -60,    39,   -60
};
...
{
       0,    19,    20,     0,     2,     4,     6,     5,     0,     1,
       3,    60,     0,    16,     0,     0,     9,     0,     8,    11,
       0,    18,     0,     0,     0,    12,     0,    15,     7,    10,
       0,    17,    22,    13,    14,     0,     0,     0,     0,     0,
       0,    35,     0,    28,    57,    21,    27,    26,    25,    24,
      23,     0,    37,    39,    47,    51,    55,    58,    56,     0,
      32,     0,     0,     0,    34,    48,    49,    41,    40,    42,
      43,    44,    45,     0,     0,    52,    53,     0,     0,    63,
       0,     0,    33,     0,    54,    38,    55,    46,    50,    36,
      65,     0,    62,     0,     0,     0,    61,     0,    59,    29,
      31,    64,     0,    30
};
...
{
      39,     8,    20,    42,    14,    29,    24,     3,     0,    20,
       6,    22,     8,    20,    24,    73,    74,    28,    29,    77,
      59,    29,    32,    62,    20,    20,    22,    22,    35,    24,
      26,    27,    28,    29,    28,    94,    95,    11,    12,    78,
      79,    80,     3,   102,    22,     6,     5,     8,     7,    21,
      28,    29,     5,    22,     7,    24,    23,    25,    97,    20,
...
static const yytype_int8 yystos[] =
{
      ...
      24,    50,    20,    50,    23,    53,    58,    55,    57,    50,
      50,    61,    62,    50,    23,    23,    23,    21,    25,    44,
      44,    50,     4,    44
};
...
#line 1247 "src/parser.tab.c"
  ...
  case 7: /* fun_decl: tipo id LPAREN params RPAREN composto_decl  */
#line 45 "src/parser.y"
    ...
    TreeNode * t;
    t = newNode(yyvsp[-5]->token, yyvsp[-4]->lexema, FunNode, yyvsp[-4]->lineno);
    t->childL = yyvsp[-2];
    t->childM = yyvsp[0];
    destroiNo(yyvsp[-5]);
    destroiNo(yyvsp[-4]);
...
#line 1275 "src/parser.tab.c"
  ...
  case 10: /* param_lista: param_lista COMMA param  */
...
#line 78 "src/parser.y"
        {
            ...
            TreeNode * t;
            t = newNode(yyvsp[-1]->token, yyvsp[0]->lexema, ParamNode, yyvsp[0]->lineno);
            destroiNo(yyvsp[-1]);
            destroiNo(yyvsp[0]);
...
#line 1315 "src/parser.tab.c"
  ...
  case 13: /* param: tipo id LBRACKET RBRACKET  */
#line 88 "src/parser.y"
        {
             // cria no do tipo vetor parametro
            TreeNode * t;
            t = newNode(yyvsp[-3]->token, yyvsp[-2]->lexema, VetorParamNode, yyvsp[-2]->lineno);
            destroiNo(yyvsp[-3]);
            destroiNo(yyvsp[-2]);
            // destroi os nos tipo e id que servem apenas para a construcao do no parametro
            yyval = t;
...
#line 1329 "src/parser.tab.c"
  ...
  case 14: /* local_decl: local_decl var_decl  */
...
#line 1349 "src/parser.tab.c"
  ...
  case 15: /* local_decl: %empty  */
#line 112 "src/parser.y"
    {yyval = NULL;}
#line 1355 "src/parser.tab.c"
    break;

  case 16: /* var_decl: tipo id SEMICOLON  */
#line 114 "src/parser.y"
                             {
            //cria o no var_decl
            TreeNode * t;
            t = newNode(yyvsp[-2]->token, yyvsp[-1]->lexema, Decl_varNode, yyvsp[-1]->lineno);
            destroiNo(yyvsp[-2]);
            destroiNo(yyvsp[-1]);
...
#line 1369 "src/parser.tab.c"
  ...
  case 17: /* var_decl: tipo id LBRACKET num RBRACKET SEMICOLON  */
#line 123 "src/parser.y"
                                                 {
            // cria o no do tipo Decl_vetorNode
            TreeNode * t;
            t = newNode(yyvsp[-5]->token, yyvsp[-4]->lexema, Decl_vetorNode, yyvsp[-4]->lineno);
            t->childL = yyvsp[-2];
            destroiNo(yyvsp[-5]);
            destroiNo(yyvsp[-4]);
            // destroi os nos auxiliares tipo e id
...
#line 188 "src/parser.y"
                ...
                TreeNode * fE;
                TreeNode * fM;
                p = newNode(IF, "if", IfNode, yyvsp[-2]->lineno);
                fE = yyvsp[-2];
                fM = yyvsp[0];
                p->childL = fE;
                p->childM = fM;
...
#line 199 "src/parser.y"
                ...
                TreeNode * fM;
                TreeNode * fD;
                p = newNode(IF, "if", IfNode, yyvsp[-4]->lineno);
                fE = yyvsp[-4];
                fM = yyvsp[-2];
                fD = yyvsp[0];
                p->childL = fE;
...
#line 215 "src/parser.y"
                ...
                TreeNode * fE;
                TreeNode * fM;
                p = newNode(WHILE, "while", WhileNode, yyvsp[-2]->lineno);
                fE = yyvsp[-2];
                fM = yyvsp[0];
                p->childL = fE;
                p->childM = fM;
...
#line 228 "src/parser.y"
                ...
                TreeNode * p;
                TreeNode * fE;
                p = newNode(RETURN, "return", ReturnNode, yyvsp[-1]->lineno);
                fE = yyvsp[-1];
                p->childL = fE;
                yyval = p;
}
...
#line 240 "src/parser.y"
    ...
    TreeNode * fE;
    TreeNode * fM;
    p = newNode(EQUAL, "=", OpNode, yyvsp[-2]->lineno);
    fE = yyvsp[-2];
    fM = yyvsp[0];
    p->childL = fE;
    p->childM = fM;
...
#line 254 "src/parser.y"
    ...
    TreeNode * fE;
    TreeNode * fM;
    t = newNode(yyvsp[-1]->token, yyvsp[-1]->lexema, OpNode, yyvsp[-1]->lineno);
    fE = yyvsp[-2];
    fM = yyvsp[0];
    t->childL = fE;
    t->childM = fM;
...
#line 373 "src/parser.y"
        ...
        TreeNode *t;
        TreeNode * fE;
        t = newNode(yyvsp[-3]->token, yyvsp[-3]->lexema, VetorNode, yyvsp[-3]->lineno);
        fE = yyvsp[-1];
        t->childL = fE;
        destroiNo(yyvsp[-3]);
...
#line 392 "src/parser.y"
    ...
    TreeNode *t;
    TreeNode *fE;
    t = newNode(ID, yyvsp[-3]->lexema, AtivNode, yyvsp[-3]->lineno);
    destroiNo(yyvsp[-3]);
    fE = yyvsp[-1];
    t->childL = fE;
    yyval = t;
